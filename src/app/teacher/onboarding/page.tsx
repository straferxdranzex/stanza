    ...
    <div className="min-h-screen bg-[#050508] flex items-center justify-center px-6">
      <div className="max-w-lg w-full">
        <div className="text-center mb-10">
          ...
          <p className="text-white/50">Get set up so students can find and book you.</p>
        </div>
          ...
          {[
            {
              ...
              desc: 'Required before students can book. Takes a few minutes.',
              href: '/teacher/settings/stripe',
              label: 'Set up payouts →',
            },
            {
              step: '2',
              title: 'Create your first lesson',
              desc: 'Add pricing, duration, and skill level.',
            ...
            },
            {
              ...
              desc: 'Add time slots so students can book with you.',
            ...
            },
            {
              ...
              desc: 'Add a bio, headline, and specialties.',
            ...
            <div key={step} className="glass rounded-2xl p-5 flex items-start gap-4">
              ...
              <Link
                href={href}
                className="text-sm text-[#C9A84C] hover:text-[#E8C87A] whitespace-nowrap transition-colors"
              >
                {label}
              </Link>
            </div>
